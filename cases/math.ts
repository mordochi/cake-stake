...
export const addmod = (a: bigint, b: bigint, N: bigint): bigint =>
  mod(a + b, N);
export const mulmod = (a: bigint, b: bigint, N: bigint): bigint =>
  mod(a * b, N);
...
export const mulDiv = (x: bigint, y: bigint, denominator: bigint): bigint => {
  ...
  const remainder = mulmod(x, y, denominator);
